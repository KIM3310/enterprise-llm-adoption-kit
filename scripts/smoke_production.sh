...
base="${1:-https://enterprise-llm-kit.pages.dev}"
base="${base%/}"
...
check_endpoint "/" "text/html" "/" "<title>LLM Adoption Atelier</title>"
check_endpoint "/about" "text/html" "/about" "<h1>About LLM Adoption Atelier</h1>"
