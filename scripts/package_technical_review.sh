...
copy_if_exists "$ROOT_DIR/docs/review_assets/account_plan_template.md" "$OUT_DIR/account_plan_template.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/executive_summary_template.md" "$OUT_DIR/executive_summary_template.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/technical_deep_dive_outline.md" "$OUT_DIR/technical_deep_dive_outline.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/workshop_facilitator_guide.md" "$OUT_DIR/workshop_facilitator_guide.md"
copy_if_exists "$ROOT_DIR/docs/ops/customer_success_raci.md" "$OUT_DIR/customer_success_raci.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/security_compliance_packet.md" "$OUT_DIR/security_compliance_packet.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/llm_workspace_checklist.md" "$OUT_DIR/llm_workspace_checklist.md"
copy_if_exists "$ROOT_DIR/docs/technical_review/rfp_requirements_matrix.md" "$OUT_DIR/rfp_requirements_matrix.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/qbr_template.md" "$OUT_DIR/qbr_template.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/sample_scenario_onepager.md" "$OUT_DIR/sample_scenario_onepager.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/executive_summary_template_kr.md" "$OUT_DIR/executive_summary_template_kr.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/workshop_facilitator_guide_kr.md" "$OUT_DIR/workshop_facilitator_guide_kr.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/account_plan_template_kr.md" "$OUT_DIR/account_plan_template_kr.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/demo_script_exec.md" "$OUT_DIR/demo_script_exec.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/demo_script_eng.md" "$OUT_DIR/demo_script_eng.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/integration_demo_checklist.md" "$OUT_DIR/integration_demo_checklist.md"
copy_if_exists "$ROOT_DIR/docs/review_assets/exec_value_dashboard" "$OUT_DIR/exec_value_dashboard"
