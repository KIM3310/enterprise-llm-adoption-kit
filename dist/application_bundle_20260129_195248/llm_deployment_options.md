...
Purpose: help enterprise customers choose the right adoption path and align on governance, security, and delivery expectations.
...
- Use API for prioritized production workflows or customer-facing use cases
- Reuse evals and safety policies across both paths to keep standards consistent

## Evidence in this repo
- Discovery artifacts: `docs/sales/discovery_questionnaire.md`, `docs/sales/korea_stakeholder_map.md`
...
- Workspace checklist: `docs/sales/llm_workspace_checklist.md`
