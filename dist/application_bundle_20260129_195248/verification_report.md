...
## Outputs Generated
- Workshop snapshot: `docs/workshops/output/latest/snapshot.md`
...
# Workshop
python3 app/backend/scripts/run_workshop.py --output-dir docs/workshops/output/demo_run
python3 app/backend/scripts/capture_workshop_outputs.py --output-dir docs/workshops/output/latest
