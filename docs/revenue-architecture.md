# Revenue Architecture - enterprise-llm-adoption-kit
...
| Layer | Decision |
| --- | --- |
| Target buyer / user | enterprise AI transformation lead, platform owner, or consulting team running governed LLM adoption |
| Productized offer | adoption kit with governance controls, workshop assets, service briefs, evals, and control tower surfaces |
| First paid SKU | paid workshop pack, private control tower deployment, and governance evidence bundle |
| Free lead magnet | public templates, service brief samples, and architecture docs |
| Paid expansion | fixed workshop engagement, per-workspace governance dashboard, and adapter setup |
| Data / workflow moat | governance templates, eval results, audit schema, workshop artifacts, and cloud adapter recipes |
| Private inquiry | https://kim3310-doeon-kim-portfolio.pages.dev/?offer=enterprise-llm-adoption-kit&inquiry=private-ai-readiness-sprint#private-inquiry |
...
| Repo-specific launch path | Cloudflare Pages front, FastAPI/Workers API, Supabase workspace state, R2 evidence packs, OpenRouter/Groq/Bedrock/customer key routing |
...
2. Route confidential and commercial requests through the [central Cloudflare D1 private inquiry](https://kim3310-doeon-kim-portfolio.pages.dev/?offer=enterprise-llm-adoption-kit&inquiry=private-ai-readiness-sprint#private-inquiry); keep public GitHub issues limited to non-confidential product discussion.
