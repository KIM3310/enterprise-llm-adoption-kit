# Workshops
Note: Outputs are synthetic, portfolio-only artifacts (no real customer data).
...
Outputs:
- `docs/samples/workshop_output/demo_run/`
- `docs/samples/workshop_output/latest/snapshot.md`
