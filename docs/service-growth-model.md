# Service Growth Model - enterprise-llm-adoption-kit
...
| Field | Decision |
|---|---|
| Service type | LLM governance rollout kit |
| Primary reader or buyer | CIO, CISO, governance, and AI enablement teams. |
| Wedge | Governance workshop, policy inventory, and controlled starter implementation. |
