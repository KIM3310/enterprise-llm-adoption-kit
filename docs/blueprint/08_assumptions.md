...
2) Mock JWT auth is acceptable for architecture walkthrough; real OIDC/SAML integration is documented but not implemented.
...
6) Evaluation scoring can be heuristic or manual; rubric defines expected architecture process.
