...
2) Mock JWT auth is acceptable for a technical review demo; real OIDC/SAML integration is documented but not implemented.
...
6) Evaluation scoring can be heuristic or manual; rubric defines the expected review process.
