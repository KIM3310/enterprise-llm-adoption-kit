...
Enterprise LLM Adoption Kit is a reproducible reference implementation for evaluating, governing, and operating LLM-enabled workflows.

## What It Shows

- Policy-aware request handling and redaction boundaries.
- Evaluation templates, sample reports, and red-team summaries.
