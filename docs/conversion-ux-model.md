# Conversion UX Model - Enterprise LLM Adoption Kit
...
| Primary buyer or user | Enterprise AI, IT governance, security, platform, and operations teams. |
| Value wedge | Governance toolkit with RBAC, redaction, prompt-injection checks, evals, and rollout controls. |
...
- Put Policy coverage on the pilot scorecard.
