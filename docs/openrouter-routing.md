...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `openai/gpt-5.4-mini` | Enterprise LLM adoption workshop, governance briefs, and architecture decisions. |
...
OPENROUTER_HTTP_REFERER=https://enterprise-llm-adoption-kit.pages.dev
OPENROUTER_APP_TITLE=enterprise-llm-adoption-kit
```
