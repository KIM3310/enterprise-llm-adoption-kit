# Service Architecture - enterprise-llm-adoption-kit
...
- **Lane:** LLM governance rollout kit
- **Primary buyer:** CIO, CISO, governance, and AI enablement teams
- **First motion:** Governance workshop, policy inventory, and controlled starter implementation

## Recommended Architecture

Static docs/demo plus FastAPI or Workers API for policy checks, managed Postgres for audit logs, R2 for policy artifacts and signed reports.
...
- no private data in demos
- RBAC before persistence
- audit export review before sharing
