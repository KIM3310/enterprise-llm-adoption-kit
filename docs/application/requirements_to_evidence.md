...
- Demo checklist: `docs/sales/integration_demo_checklist.md`
...
- ROI + success criteria: `docs/sales/roi/`, `docs/sales/poc_output/`
...
- Sample scenario: `docs/sales/sample_scenario_onepager.md`
